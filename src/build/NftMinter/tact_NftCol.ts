...
export function loadMintNft(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 2590352207) { throw Error('Invalid prefix'); }
...
const NftCol_types: ABIType[] = [
    ...
    {"name":"MintNft","header":2590352207,"fields":[{"name":"body","type":{"kind":"simple","type":"cell","optional":false}}]},
