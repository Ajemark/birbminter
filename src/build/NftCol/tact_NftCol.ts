...
export function loadMintNft(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 2229142577) { throw Error('Invalid prefix'); }
    let _contractAddress = sc_0.loadAddress();
    let _itemIndex = sc_0.loadIntBig(257);
    let _body = sc_0.loadRef();
    return { $$type: 'MintNft' as const, contractAddress: _contractAddress, itemIndex: _itemIndex, body: _body };
}
...
function dictValueParserItemData(): DictionaryValue<ItemData> {
 ...
 type NftCol_init_args = {
    $$type: 'NftCol_init_args';
}

function initNftCol_init_args(src: NftCol_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
    };
}

async function NftCol_init() {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initNftCol_init_args({ $$type: 'NftCol_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const NftCol_errors: { [key: number]: { message: string } } = {
...
const NftCol_types: ABIType[] = [
    ...
    {"name":"MintNft","header":2229142577,"fields":[{"name":"contractAddress","type":{"kind":"simple","type":"address","optional":false}},{"name":"itemIndex","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"body","type":{"kind":"simple","type":"cell","optional":false}}]},
...
const NftCol_getters: ABIGetter[] = [
...
const NftCol_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"text","text":"Mint"}},
    {"receiver":"internal","message":{"kind":"typed","type":"Deploy"}},
]

export class NftCol implements Contract {
    
    static async init() {
        return await NftCol_init();
    }
    
    static async fromInit() {
        const init = await NftCol_init();
        const address = contractAddress(0, init);
        return new NftCol(address, init);
    }
    
    static fromAddress(address: Address) {
        return new NftCol(address);
    }
    ...
    readonly abi: ContractABI = {
        types:  NftCol_types,
        getters: NftCol_getters,
        receivers: NftCol_receivers,
        errors: NftCol_errors,
    };
